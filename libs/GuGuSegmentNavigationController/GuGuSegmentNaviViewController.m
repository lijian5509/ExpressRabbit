...
-(id)initWithItems:(NSArray*)titleArray andControllers:(NSArray*)controllers
{
    ...
    if (self)
    {
        ...
        barView = [[GuGuSegmentBarView alloc]initWithFrame:CGRectMake(0, 20, 320, kBarHeight+10) andItems:titleArray];
        
        barView.backgroundColor = RGBCOLOR(230, 230, 230);
        [self.view addSubview:barView];
        barView.clickDelegate = self;
        self.view.backgroundColor = [UIColor whiteColor];
        contentTable = [[GuGuLandscapeTableView alloc]initWithFrame:CGRectMake(0,  kBarHeight + 20+10, 320, self.view.frame.size.height - kBarHeight - y) Array:controllers];
